  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span
                    class="hidden-xs">{{ ucfirst(Auth::user()->lastname).', '. ucfirst(Auth::user()->firstname) }}</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{ ucfirst(Auth::user()->lastname).', '. ucfirst(Auth::user()->firstname) }} - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>{{ ucfirst(Auth::user()->lastname).', '. ucfirst(Auth::user()->firstname) }}</p>
            </div>
          </div>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015- {{ Carbon\carbon::now()->year }} Done-Right Systems Inc.</strong> All rights
        reserved.
      </footer>
